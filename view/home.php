            ...
            <div class="price">
                ...
                <form id="filter-form" method="POST" action="">
                    <section name="price" class="list-price">
                        ...
                        <br><input type="radio" name="price" value="1000000-5000000" id="price3"> 1.000.000đ — 5.000.000đ
                        <br><input type="radio" name="price" value="5000000-7000000" id="price4"> 5.000.000đ — 7.000.000đ
                    </section>
            </div>
